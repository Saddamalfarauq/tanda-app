...
import {
    AlertTriangle, ArrowLeft, BookOpen, Building2, Calendar, Clock, CloudSunRain, Droplets, Flame,
    Handshake, HeartPulse, HelpCircle, Info, MapPin, PartyPopper, Users
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={styles.formContent}>
          ...
          {/* 2. Kategori Broadcast (Pakai Picker) */}
          <Text style={styles.sectionLabel}>2. Kategori *</Text>
          <View style={[styles.inputWrapper, { paddingHorizontal: 0, marginBottom: 18 }]}>
            <Picker
              selectedValue={category}
              onValueChange={setCategory}
              style={{ backgroundColor: '#f7fafc', borderRadius: 12, borderColor: '#e5e7eb', borderWidth: 1 }}
              dropdownIconColor="#64748b"
            >
              <Picker.Item label="Pilih kategori broadcast..." value="" />
              {CATEGORIES.map((c) => (
